...
model TestModelEvaluation_tflite
  ...
  replaceable TFLite.NNHeatTransfer_tflite heatTransfer constrainedby Modelica.Fluid.Pipes.BaseClasses.HeatTransfer.PartialPipeFlowHeatTransfer(
...
"));
end TestModelEvaluation_tflite;
