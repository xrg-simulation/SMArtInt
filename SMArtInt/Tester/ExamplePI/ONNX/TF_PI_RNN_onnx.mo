...
equation
  ...
  connect(u, evaluateRecurrentNeuralNet.u[1, 1]) annotation (Line(points={{-120,0},{-12,0}}, color={0,0,127}));
  connect(evaluateRecurrentNeuralNet.y[1, 1], y) annotation (Line(points={{11,0},{110,0}}, color={0,0,127}));
