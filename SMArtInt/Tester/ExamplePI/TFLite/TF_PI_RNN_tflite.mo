...
equation
  ...
  connect(u, evaluateRecurrentNeuralNet.u[1, 1]) annotation (Line(points={{-106,0},{-59,0},{-59,0},{-10,0}}, color={0,0,127}));
  connect(evaluateRecurrentNeuralNet.y[1, 1], y) annotation (Line(points={{10,0},{98,0}}, color={0,0,127}));
