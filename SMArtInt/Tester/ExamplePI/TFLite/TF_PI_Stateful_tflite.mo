...
model TF_PI_Stateful_tflite
  ...
  Blocks.EvaluateStatefulRecurrentNeuralNet controller(pathToTfLiteFile=Modelica.Utilities.Files.loadResource("modelica://SMArtInt/Resources/ExampleNeuralNets/PIController/PI_stateful.tflite"),samplePeriod=10)   annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
equation
