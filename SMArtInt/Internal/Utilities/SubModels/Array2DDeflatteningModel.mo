...
model Array2DDeflatteningModel
  ...
  Modelica.Blocks.Interfaces.RealInput flatArray[batchSize*numberOfOutput] annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  Modelica.Blocks.Interfaces.RealOutput arrayOut[batchSize,numberOfOutput] annotation (Placement(transformation(extent={{100,-10},{120,10}}), iconTransformation(extent={{100,-10},{120,10}})));
equation
  ...
  annotation (Icon(graphics={Rectangle(
          ...
          fillPattern=FillPattern.Solid),Bitmap(extent={{-80,-80},{80,80}}, fileName="modelica://SMArtInt/Resources/Images/Icon_Deflattening.png")}));
