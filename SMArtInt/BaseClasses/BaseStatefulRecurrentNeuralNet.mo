...
equation
  ...
  connect(array2DFlatteningModel.flatArray, runInferenceFlatInputStatefulRNN.u) annotation (Line(points={{-20,0},{-12,0}},  color={0,0,127}));
  connect(runInferenceFlatInputStatefulRNN.y, array2DDeflatteningModel.flatArray) annotation (Line(points={{10,0},{18,0}},   color={0,0,127}));
  annotation (
